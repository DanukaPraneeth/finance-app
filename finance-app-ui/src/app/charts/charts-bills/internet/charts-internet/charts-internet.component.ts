...
@Component({
    ...
    templateUrl: './charts-internet.component.html',
    styleUrls: ['./charts-internet.component.scss']
})
export class ChartsInternetComponent implements OnInit {
    ...
    private createYearCharts(selectedValue: string) {
        this._internetBillService.getMonthlyExpenseOfYear(selectedValue, (response) => {
            this.monthlyExpenseInYearList = response;
            this.createBarChart(
        ...
        this._internetBillService.getLocationExpenseOfYear(selectedValue, (response) => {
    ...
    private createMonthCharts(selectedValue: string) {
        ...
        this._internetBillService.getYearlyExpenseOfMonth(month, (response) => {
        ...
        this._internetBillService.getLocationExpenseOfMonth(month, (response) => {
            this.locationExpenseInYearList = response;
            this.createPieChart(
                this.locationExpenseInYearList.map(locationExpense => [locationExpense.expense]),
                this.locationExpenseInYearList.map(locationExpense => [locationExpense.location])
