...
@Component({
    ...
    templateUrl: './charts-electricity.component.html',
    styleUrls: ['./charts-electricity.component.scss']
})
export class ChartsElectricityComponent implements OnInit {
    ...
    private createYearCharts(selectedValue: string) {
        this._electrictyBillService.getMonthlyExpenseOfYear(selectedValue, (response) => {
            this.monthlyExpenseInYearList = response;
            this.createBarChart(
        ...
        this._electrictyBillService.getLocationExpenseOfYear(selectedValue, (response) => {
