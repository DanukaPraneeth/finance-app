...
@Component({
    ...
    templateUrl: './charts-telephone.component.html',
    styleUrls: ['./charts-telephone.component.scss']
})
export class ChartsTelephoneComponent implements OnInit {
    ...
    private createYearCharts(selectedValue: string) {
        this._telephoneBillService.getMonthlyExpenseOfYear(selectedValue, (response) => {
            this.monthlyExpenseInYearList = response;
            this.createBarChart(
        ...
        this._telephoneBillService.getLocationExpenseOfYear(selectedValue, (response) => {
